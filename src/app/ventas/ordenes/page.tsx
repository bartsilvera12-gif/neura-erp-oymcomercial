    ...
    <div className="space-y-8">
      ...
      <div className="flex flex-wrap items-start justify-between gap-4">
        <div>
          ...
          <h1 className="mt-1 text-lg font-semibold tracking-tight text-slate-900">Órdenes de venta</h1>
          <p className="mt-0.5 text-xs text-slate-500">Historial, anulaciones y reimpresión de tickets</p>
        </div>
        <Link
          href="/ventas"
