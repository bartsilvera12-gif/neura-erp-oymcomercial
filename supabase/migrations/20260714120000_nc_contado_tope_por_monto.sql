...
-- schema hardcodeado. En runtime la app solo usa la copia de `oymcomercial`.
--
-- Por eso se actualiza ÚNICAMENTE `oymcomercial` y NO la plantilla `zentra_erp`:
...
CREATE OR REPLACE FUNCTION oymcomercial.nota_credito_aplicar_aprobacion_set(
  p_data_schema text,
...
COMMENT ON FUNCTION oymcomercial.nota_credito_aplicar_aprobacion_set(text, uuid, uuid, uuid, numeric) IS
