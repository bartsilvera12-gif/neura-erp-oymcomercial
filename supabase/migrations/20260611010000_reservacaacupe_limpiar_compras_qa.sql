...
-- el reporte de Estado de cuenta (card Compras / Resultado). Solo schema oymcomercial.
...
BEGIN
  ...
  DELETE FROM oymcomercial.movimientos_inventario
  ...
  DELETE FROM oymcomercial.compras
