...
ALTER TABLE oymcomercial.nota_credito
...
ALTER TABLE oymcomercial.nota_credito_electronica
  ADD COLUMN IF NOT EXISTS sifen_cancelado_at timestamptz,
  ADD COLUMN IF NOT EXISTS sifen_cancelacion_motivo text;

CREATE OR REPLACE FUNCTION oymcomercial.nota_credito_aplicar_cancelacion_set(
  p_data_schema text,
...
COMMENT ON FUNCTION oymcomercial.nota_credito_aplicar_cancelacion_set(text, uuid, uuid, uuid, uuid, text, timestamptz) IS
