-- Fase 3 (solo schema oymcomercial): cobro inteligente + entidades bancarias.
...
ALTER TABLE oymcomercial.entidades_bancarias
  ADD COLUMN IF NOT EXISTS codigo text;

CREATE UNIQUE INDEX IF NOT EXISTS uq_entidades_bancarias_codigo
  ON oymcomercial.entidades_bancarias (empresa_id, lower(codigo))
