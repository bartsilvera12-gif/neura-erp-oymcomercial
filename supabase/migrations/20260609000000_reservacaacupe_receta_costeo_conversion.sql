-- Costeo de recetas con CONVERSIÓN de unidades por familia (solo oymcomercial).
...
GRANT EXECUTE ON FUNCTION oymcomercial.fn_receta_costeo(uuid) TO anon, authenticated, service_role;
